        ...
        "boxes": [
            {
                "box": {
                    ...
                    "depth": 1,
                    "id": "obj-49",
                    "items": [ "1-hello-max.maxpat", ",", "1-hello-world.maxpat", ",", "2-hello-max.maxpat", ",", "Practice", ",", "Practice/patchers", ",", "Practice/Practice.maxproj", ",", "README.md" ],
                    "maxclass": "umenu",
                    "numinlets": 1,
                    "numoutlets": 3,
                    "outlettype": [ "int", "", "" ],
